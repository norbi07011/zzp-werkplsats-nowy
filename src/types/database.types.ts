    ...
    Tables: {
      ...
      accountant_reviews: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "accountant_reviews_cleaning_company_id_fkey";
          ...
          {
            foreignKeyName: "accountant_reviews_employer_id_fkey";
            columns: ["employer_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "accountant_reviews_worker_id_fkey";
            columns: ["worker_id"];
            isOneToOne: false;
      ...
      cleaning_reviews: {
        ...
        Relationships: [
          {
            foreignKeyName: "cleaning_reviews_accountant_id_fkey";
            columns: ["accountant_id"];
            isOneToOne: false;
            referencedRelation: "accountants";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "cleaning_reviews_worker_id_fkey";
            columns: ["worker_id"];
            isOneToOne: false;
            referencedRelation: "v_workers";
            referencedColumns: ["id"];
      ...
      employer_reviews: {
        ...
        Relationships: [
          {
            foreignKeyName: "employer_reviews_accountant_id_fkey";
            columns: ["accountant_id"];
            isOneToOne: false;
            referencedRelation: "accountants";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "employer_reviews_cleaning_company_id_fkey";
            columns: ["cleaning_company_id"];
            isOneToOne: false;
            referencedRelation: "cleaning_companies";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "employer_reviews_reviewed_by_admin_fkey";
          ...
          {
            foreignKeyName: "employer_reviews_reviewee_id_fkey";
            columns: ["reviewee_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "employer_reviews_reviewer_id_fkey";
            columns: ["reviewer_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "employer_reviews_worker_id_fkey";
            columns: ["worker_id"];
            isOneToOne: false;
            referencedRelation: "v_workers";
            referencedColumns: ["id"];
      ...
      generated_certificates: {
        Row: {
          ...
          worker_btw_sofi: string | null;
          worker_full_name: string;
          worker_id: string | null;
          worker_kvk: string | null;
      ...
      invoice_kilometer_entries: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "invoice_kilometer_entries_vehicle_id_fkey";
            columns: ["vehicle_id"];
            isOneToOne: false;
            referencedRelation: "invoice_vehicles";
            referencedColumns: ["id"];
          }
        ];
      };
      ...
      posts: {
        Row: {
          ...
          ad_ctr_percent: number | null;
          ad_duration_days: number | null;
          ad_impressions_count: number;
          ad_target_audience: string[] | null;
          ad_type: string | null;
          ad_website: string | null;
          angry_count: number;
          announcement_category: string | null;
          announcement_expires_at: string | null;
          announcement_notify_users: boolean | null;
          announcement_pinned: boolean | null;
          ...
          job_hours_per_week: number | null;
      ...
      profile_views: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_views_accountant_id_fkey";
            columns: ["accountant_id"];
            isOneToOne: false;
            referencedRelation: "accountants";
            referencedColumns: ["id"];
      ...
      reviews: {
        ...
        Relationships: [
          {
            foreignKeyName: "reviews_accountant_id_fkey";
            columns: ["accountant_id"];
            isOneToOne: false;
            referencedRelation: "accountants";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "reviews_cleaning_company_id_fkey";
            columns: ["cleaning_company_id"];
            isOneToOne: false;
            referencedRelation: "cleaning_companies";
            referencedColumns: ["id"];
